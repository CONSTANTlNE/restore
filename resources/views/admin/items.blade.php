                ...
                <div class="box-body space-y-3">
                    <table id="TableToExport" data-datatable class="display nowrap" style="width:100%;">
                        ...
                        <tr>
                            ...
                            <th class="th-center">ჩაბარებული</th>
                            ...
                            <tr style="text-align: center">
                                ...
                                <td>
                                    @if($item->status == 1)
                                        ...
                                        <form action="{{route('item-finish-remove')}}" method="post">
                                            @csrf
                                    ...
                                    <div id="delete{{$index}}"
                                        ...
                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                            <form id="deleteForm{{$index}}" method="post"
                                                ...
                                                <input style="display: none" name="order_id"
                                                       value="{{$item->order_id}}">
                                                    ...
                                                    <div class="ti-modal-body px-4">
                                                        <div class="px-3">
                                                            ...
                                                            <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 pt-2 text-center mt-2 flex flex-col">
                                                                <label for="package_value" class="form-label m-auto">ამანათის
                                                                    ღირებულება</label>
                                                                <input value="{{$item->item_value}}"
                                                                       style="width:100px;padding: 8px" type="text"
                                                                       name="package_value"
                                                                       class="form-control validation m-auto"
                                                                       id="package_value" placeholder="ღირებულება">
                                                            </div>
                                                            <div class="flex flex-col mt-2">
