                    ...
                    <div style="max-width: 40rem!important"
                        ...
                        <form id="orderForm" method="post" action="{{route('order.store')}}">
                            ...
                            <div class="ti-modal-content">
                                <div class="ti-modal-header orerHeader ">
                                    <div class="flex justify-center order-header">
                                        <div class="flex justify-center orderQty">
                                            <h6 style="width:100px;text-align: center" class="ggggg2 modal-title text-[1rem] font-semibold">
                                        ...
                                        <div class="flex justify-center orderNo">
                                            <h6 style="width:100px;margin-left: 2rem;text-align: center"
                                                class="modal-title ggggg text-[1rem] font-semibold">შეკვეთის ნომერი:</h6>
                                ...
                                <div style="border-bottom: rgb(255 255 255 / 0.1) solid 1px" class="flex justify-center mt-3 pb-3">
                                    <button id="sum" style="margin-right:1rem;margin-bottom: 0" type="button" class="ti-btn ti-btn-outline-light ti-btn-wave">დაჯამება</button>
                                    <input disabled class="form-control validation" name="sum_value" id="total_price" type="text"
                                           style="width:80px;border:1px solid white;padding-right: 6px;padding-left: 6px;text-align: center">
                                </div>
                ...
                <div class="box-body space-y-3">
                    <table id="TableToExport" data-datatable class="display nowrap" style="width:100%;">
                        ...
                        <tr>
                            ...
                            <th class="th-center">Office</th>
                            <th class="th-center">Age</th>
                            <th class="th-center">Start date</th>
                            <th class="th-center">Salary</th>
                            <th class="th-center">Extn.</th>
                            <th class="th-center">E-mail</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
